...
import jgr.iam.repository.*;

@NoArgsConstructor
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class ControllerTestDataUtil {
    // Logger
    private final static Logger logger = LogManager.getLogger(ControllerTestDataUtil.class.getCanonicalName());
    ...
    public void setUp() {
        logger.debug("setUp: Connect to iamDB.");
    ...
    public void tearDown() {
        logger.debug("tearDown: Close connection to iamDB.");
        connector.close();
    }
    ...
    public void createTestData() {
        try {
            logger.debug("createTestData: Insert Data.");
            // Application 1: IAM
            ...
            logger.debug("createTestData: Data Inserted.");
        }
        catch (SQLException e) {
    ...
    public void deleteTestData() {
        try {
            logger.debug("deleteTestData: Delete Data.");
            ...
            logger.debug("deleteTestData: Data Deleted.");
        }
        catch (SQLException e) {
    ...
    public int getPermissionId(String name) {
        try {
            return pRepository.getByName(name).getId();
        }
        catch (SQLException e) {
            ExceptionHandlerTestUtil.Handle(logger, "getPermissionId", e);
            return -1;
        }
    }
}
